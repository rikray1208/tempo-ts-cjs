export declare const tempoLocal: {
    ...
    serializers: {
        transaction(transaction: import("viem").OneOf<import("./ox/TransactionEnvelopeFeeToken.js").TransactionEnvelopeFeeToken | import("viem").TransactionSerializable>, signature?: import("viem").Signature | undefined): `0x77${string}` | `0x02${string}` | `0x01${string}` | `0x03${string}` | `0x04${string}` | import("viem").TransactionSerializedLegacy;
    };
};
